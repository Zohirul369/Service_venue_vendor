...
public class MovingAdapter extends FirebaseRecyclerAdapter<ViewModel, MovingAdapter.myViewHolder> {

    public MovingAdapter(@NonNull FirebaseRecyclerOptions<ViewModel> options) {
        super(options);
    }
