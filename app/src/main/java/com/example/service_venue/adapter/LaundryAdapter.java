...
public class LaundryAdapter extends FirebaseRecyclerAdapter<ViewModel, LaundryAdapter.myViewHolder> {

    public LaundryAdapter(@NonNull FirebaseRecyclerOptions<ViewModel> options) {
        super(options);
    }
