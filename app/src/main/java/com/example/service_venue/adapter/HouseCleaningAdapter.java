...
public class HouseCleaningAdapter extends FirebaseRecyclerAdapter<ViewModel, HouseCleaningAdapter.myViewHolder> {

    public HouseCleaningAdapter(@NonNull FirebaseRecyclerOptions<ViewModel> options) {
        super(options);
    }
