...
public class PainterAdapter extends FirebaseRecyclerAdapter<ViewModel, PainterAdapter.myViewHolder> {

    public PainterAdapter(@NonNull FirebaseRecyclerOptions<ViewModel> options) {
        super(options);
    }
