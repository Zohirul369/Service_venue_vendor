...
public class BeautyParlourAdapter extends FirebaseRecyclerAdapter<ViewModel, BeautyParlourAdapter.myViewHolder> {

    public BeautyParlourAdapter(@NonNull FirebaseRecyclerOptions<ViewModel> options) {
        super(options);
    }
